...
def _validate_current_file():
    ...
    if Check.part():
        try:
            ...
            Check.equal('je_deljivo_s_katerim_od(10, [2])', True)
            Check.equal('je_deljivo_s_katerim_od(10, [5])', True)
            Check.equal('je_deljivo_s_katerim_od(10, [3])', False)
            Check.equal('je_deljivo_s_katerim_od(20, [4])', True)
    ...
    if Check.part():
        try:
            ...
            Check.equal('je_prastevilo(16)', False)
            Check.equal('je_prastevilo(19)', True)
